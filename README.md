--[[
    ...
    - Interface completamente em português para uso exclusivo de brasileiros.
    - Tema de cores: Amarelo e Preto.
    - Interface avançada com animações suaves, feedback visual e suporte a múltiplas resoluções.
    - Aimbot avançado com opções de personalização (Silent, Legit, Rage, etc.).
    - Wallhack com ESP, Chams, Tracers, Head Dots, Health Bar e mais.
    - Funções adicionais: SpeedHack, Fly, NoClip, AutoClicker, Anti-Aim, etc.
    - Sistema de Key para autenticação com a chave "DODIDEIYUCHEATS".
    - Suporte apenas para PC, com notificação e remoção em dispositivos móveis.
    - Interface otimizada com Pepsi's UI Library, com abas e seções organizadas.
    - Feito pela Team TEST.
]]
