...
-- Note: Original external URLs removed to prevent logging. Host Aimbot.lua and Wall Hack.lua locally or on a trusted server.
...
MainFrame:InjectCSS(AnimationCSS)
...
AimbotModule.Settings.LockPart = Parts[1]; Values:AddDropdown({
	Name = "Lock Part",
	Value = Parts[1],
	Callback = function(New, Old)
